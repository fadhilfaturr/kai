...
<form action="{{ route('hardwarel.store') }}" name="tambah" method="POST">
    @csrf
...
<table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($hardware_l as $index => $hardware)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $hardware->unit }}</td>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ingin Menghapus Data ?');"
                                                action="{{ route('hardwarel.destroy', $hardware->id) }}" method="POST">
                                                <a href="{{ route('hardwarel.edit', $hardware->id) }}"
