...
<form action="{{ route('jaringant.store') }}" name="tambah" method="POST">
    @csrf
...
<table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($jaringan_t as $index => $jaringan)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $jaringan->unit }}</td>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('jaringant.destroy', $jaringan->id) }}" method="POST">
                                                <a href="{{ route('jaringant.edit', $jaringan->id) }}"
